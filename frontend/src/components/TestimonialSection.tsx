...
const testimonials = [
  {
    ...
    quote:
      "KerMedix Health has revolutionized how I access patient records.",
  },
  {
    name: "Ramesh Kumar",
    role: "Construction Worker",
    quote:
      "Doctors can instantly access my vaccination history.",
  },
  {
    name: "Dr. Mohammed Salim",
    role: "Public Health Officer",
    quote:
      "Multilingual support helps us reach diverse communities.",
  },
  {
    name: "Anjali Menon",
    role: "Staff Nurse, Trivandrum",
    quote:
      "Digital health records improved coordination between departments.",
  },
  {
    name: "Suresh Babu",
    role: "Factory Supervisor",
    quote:
      "My medical history stays safe and accessible even when I relocate.",
  },
  {
    name: "Dr. Neethu Thomas",
    role: "Community Health Specialist",
    quote:
      "KerMedix bridges the gap between public health policy and practice.",
  },
];
              ...
              return (
                ...
                >
                  <div className="relative bg-green-600 text-white rounded-3xl shadow-2xl px-6 md:px-8 pt-20 pb-10">
                    <div className="absolute -top-12 left-1/2 -translate-x-1/2 w-20 h-20 md:w-24 md:h-24 bg-gray-300 rounded-full border-4 border-white" />
        ...
        <div className="sm:hidden overflow-hidden">
          ...
          >
            {testimonials.map((t, i) => (
              ...
              >
                <div className="relative bg-green-600 text-white rounded-3xl shadow-xl px-6 pt-20 pb-8">
